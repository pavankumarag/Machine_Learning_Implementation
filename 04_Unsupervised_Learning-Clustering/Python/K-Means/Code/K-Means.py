...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 23 17:43:17 2016
...
for i in range(1,11):
    kmeans = KMeans(n_clusters=i, init ='k-means++', max_iter=800, n_init=10,
                    random_state=0)
    kmeans.fit(X)
...
kmeans = KMeans(n_clusters=5, init ='k-means++', max_iter=800, n_init=10,
                    random_state=0)
